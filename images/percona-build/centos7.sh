...
# cyrus-sasl openldap 
CC=/opt/gcc-indiff/bin/gcc CXX=/opt/gcc-indiff/bin/g++ $VCPKG_ROOT/vcpkg install curl[core,non-http,ssl,openssl,zstd] snappy jemalloc protobuf --triplet x64-linux-dynamic --clean-after-build \
